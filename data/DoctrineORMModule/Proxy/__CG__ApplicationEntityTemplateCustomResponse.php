...
namespace DoctrineORMModule\Proxy\__CG__\Application\Entity\Template;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CustomResponse extends \Application\Entity\Template\CustomResponse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'topics', 'variables', 'html'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomResponse $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTopic(\Application\Entity\ForumTopic $topic)
    {
